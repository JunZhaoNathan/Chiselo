...
Current release: `0.1.22` for Apple Silicon Macs. See the [installation guide](docs/user/INSTALL.md) and [usage guide](docs/user/USAGE.md).
...
- [Release notes](docs/releases/RELEASE_NOTES_0.1.22_PREVIEW.md): current packaged build details.
