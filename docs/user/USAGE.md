...
Freeze Layout converts the current rendered HTML into a fixed-canvas Chiselo tab. This is useful when an HTML page, document, poster, dashboard, or presentation-like page should behave like a stable visual canvas for precise adjustment.
