...
```text
outputs/Chiselo-0.1.25.dmg
outputs/Chiselo-0.1.25-macOS-arm64-appcast.xml
...
```text
outputs/codex-build/Chiselo-0.1.25.dmg
```
...
```text
docs/releases/RELEASE_NOTES_0.1.25_PREVIEW.md
```
