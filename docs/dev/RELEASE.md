...
hdiutil verify outputs/Chiselo-0.1.3.dmg
```

## GitHub Release

1. Create a tag such as `v0.1.3`.
2. Create a GitHub release from that tag.
3. Upload `outputs/Chiselo-0.1.3.dmg`.
4. Include release notes from `docs/releases/RELEASE_NOTES_0.1.3_PREVIEW.md` for the current preview.
