...
1. Create a release tag such as `v0.1.5`.
2. Create a GitHub release from that tag.
3. Upload `outputs/Chiselo-0.1.5.dmg`.
4. Include release notes from `docs/releases/RELEASE_NOTES_0.1.5_PREVIEW.md` for the current preview.
