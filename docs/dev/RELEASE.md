...
hdiutil verify outputs/Chiselo-0.1.25.dmg
xcrun stapler validate outputs/Chiselo-0.1.25.dmg
spctl --assess --type open --context context:primary-signature --verbose=4 outputs/Chiselo-0.1.25.dmg
...
1. Create a release tag such as `v0.1.25`.
2. Create a GitHub release from that tag.
3. Upload `outputs/Chiselo-0.1.25.dmg`.
4. Include release notes from `docs/releases/RELEASE_NOTES_0.1.25_PREVIEW.md` for the current release.
