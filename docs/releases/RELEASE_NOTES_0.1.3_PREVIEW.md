...
- Added generated HTML and `.aislide` regression fixtures.
- Added an editing regression test that exercises text edits, image replacement, module movement, table edits, deck edits, duplicate/delete, and clean export.
